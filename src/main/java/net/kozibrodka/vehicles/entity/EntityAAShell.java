...
public class EntityAAShell extends Entity
{
    ...
    public EntityAAShell(World world, double d, double d1, double d2,
    ...
    public void tick()
    {
        ...
        if(movingobjectposition != null)
        {
            ...
            {
                if(movingobjectposition.entity.damage(this, damageAA/2))
                {
                    world.playSound(this, "vehicles:flak", 1.0F, 1.2F / (random.nextFloat() * 0.2F + 0.9F));
                    markDead();
                }
            } else
            {
                ...
                world.playSound(this, "vehicles:bullethit", 1.0F, 1.2F / (random.nextFloat() * 0.2F + 0.9F));
...
//                ModLoader.getMinecraftInstance().effectRenderer.addEffect(entitysmokefx);
            ...
            {
                Entity entityplane = (Entity)list1.get(k); //TODO: czy to zadziała??
