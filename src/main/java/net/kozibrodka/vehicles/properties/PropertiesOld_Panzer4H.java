...
import net.kozibrodka.vehicles.model.ModelPanzer4a_Old;
...
public class PropertiesOld_Panzer4H extends Vehicle_properties{
    ...
    public PropertiesOld_Panzer4H() {
        ...
        item_body =  new ItemInstance(ww2Parts.advancedTankBody.id, 1, 0);
