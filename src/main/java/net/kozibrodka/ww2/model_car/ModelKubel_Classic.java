package net.kozibrodka.ww2.model_car;
import net.kozibrodka.tmt.TURBO_MODEL_125.*;
import net.kozibrodka.ww2.model.ModelTruck;

public class ModelKubel_Classic extends ModelTruck {
    public ModelKubel_Classic()
    {
        char c = '\200';
        char c1 = '\200';
        ...
        bodyModel[9] = new ModelRendererTurbo(this,90, 12, c, c1);
        ...
        bodyModel[9].addBox(12F, -18F, -4F, 8, 2, 8, 0.0F);
